    ...
    public void draw(Graphics g){
        ...
        for(int i = 0; i < buttons.length; i++){//show shop bar icons
            ...
            if (i+1 == 1) {
                ...
                try {
                    img = ImageIO.read(new File("C:\\Users\\" + PPAFrame.studentID + "\\Documents\\NetBeansProjects\\PPA\\src\\ppa\\Jeb.png"));
                } catch (IOException e) {
                }
            ...
            if (i+1 == 2) {
                BufferedImage img = null;
                try {
                    img = ImageIO.read(new File("C:\\Users\\" + PPAFrame.studentID + "\\Documents\\NetBeansProjects\\PPA\\src\\ppa\\Donald.jpg"));
                } catch (IOException e) {
                }
                g.drawImage(img, buttons[i].x + 1, buttons[i].y + 1, null);
            }
